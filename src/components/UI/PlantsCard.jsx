...
const PlantsCard = ({ state: { image, title, price, previousPrice, id } }) => {
    return (
        <div className="qanaqadirstrelka card w-[260px] h-[366px] relative hover:border-b-2 hover:shadow-2xl">
            <Link to={`/flowers/${id}`}>
            ...
            <div className="flex mt-[20px] text-center flex-col">
                <h3 className="font-[Medium] text-[20px] mb-[9.5px] justify-center items-center">
                    {title}
                </h3>
